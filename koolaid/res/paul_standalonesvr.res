...
in master not in paul_standalonesvr
----------------
...
in paul_standalonesvr not in master
----------------
590d0356 Minor bugfix - incorrect URN generated 
c2b19a57 use paste.URLMap to route ala nginx 
d9c5567a LICENSE AGPLv3 <- 1ea625fb paired with d9c5567a
10b00e01 Remove extraneous assignment to older name of body 
5600adfa Better repopulate script 
7d234994 reducing size of requirements.txt 
4e2ba8fe Reduce ini file variables 
...
9ff198b6 Standalone server option for developer 
d9f7804b Improve api by having models call save and delete on themselves 
3a1bcd73 Docs: missed a delete 
...
616bb87e Naive implementation of date last modified 
21f581ac Merge branch 'master' into add_folders_to_backend Simply keeping uptodate with HEAD 
...
39dc7151 Docs: Ongoing changes to docs. 
